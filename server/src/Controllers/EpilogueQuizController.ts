...
export class EpilogueQuizController extends BaseController {
  ...
  @Example<QuizResponse>(
    apiExamples.epilogueQuizRequestQuestionExample,
    "Next question."
  )
  @Example<QuizResponse>(
    apiExamples.epilogueQuizRequestQuestionExampleCompleted,
    "Quiz completed."
  )
  ...
  @Example<QuizBlockCompletedStatsResponse>(
    apiExamples.epilogueCompletedResponse
  )
